            ...
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <NavLink :href="route('dashboard')"
                         :active="route().current('dashboard') || route().current('manager.dashboard')">
                  Dashboard
                </NavLink>
              </div>
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <NavLink :href="$page.props.auth?.user?.is_manager ? route('manager.vacations.index') : route('vacations.index')"
                         :active="route().current('vacations.index') || route().current('vacations.create') || route().current('vacations.edit') || route().current('manager.vacations.index')">
                  Vacations
                </NavLink>
              </div>
            </div>
